...
const creditReport = {
  RsBody: {
    NewApplicationEnquireSimpleV2Rs: {
      ...
      LoanSummaryValidation: {
        ...
        DaysPastDues: [
          ...
          },
          {
            ...
            ContractPhase: "CL",
            ContractType: "Personal loan (or Business loan)",
            ContractStartDate: "2023-12-16",
            ContractEndDate: "2024-07-11",
            FinancedAmount: "200",
            PaymentPeriodicityDesc: "Monthly installments-30 days",
      ...
      Score: "742",
      ContractRequestDateDt: "2026-03-30",
